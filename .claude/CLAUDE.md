...
| `.claude/plan/` | 跨会话规划 |
| `.claude/bevy-kb/` | **Bevy 知识库**（migration、patterns、BSN） |
| `.claude/skills/` | **Agent 技能**（agent-spec + bevy-api-lookup + bevy-shader-review + claude-maintainer） |
| `.claude/specs/` | **结构化合同**（project/terrain-shape/terrain-material/math） |
