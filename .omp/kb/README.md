...
├── pi/                          — Pi Agent 框架（外部依赖）
│   └── ts-conventions.md        — TypeScript 编码规范
└── project/                     — Atom 项目知识
    ├── agent/
    │   └── integration.md       — Agent sidecar 集成、组件路径、decorate 系统
    └── game/
        └── README.md            — 游戏系统（待填充）
```
...
3. Agent sidecar 集成 → 查 `kb/project/agent/`
4. BRP 协议本身 → 查 `kb/bevy/brp-protocol.md`
