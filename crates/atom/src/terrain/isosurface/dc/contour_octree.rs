use super::{
    tables::{
        EDGE_ADJACENT_OCTANTS, FACE_ADJACENT_OCTANTS, FACE_TO_EDGE_ADJACENT_OCTANTS,
        FACE_TO_EDGE_AXIS, FACE_TO_EDGE_MIRRORS, FACE_TO_EDGE_NODE_ORDERS,
    },
    Cell, CellId, CellOctree, Edge, Face,
};
...
// 从中点沿着xyz轴切分，得到8个子cell，其中有中间的点的face有12个，edge有6个
