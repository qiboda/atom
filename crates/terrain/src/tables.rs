...
impl EdgeIndex {
    pub fn to_index(&self) -> usize {
        match self {
            EdgeIndex::XAxisY0Z0 => 0,
            EdgeIndex::XAxisY1Z0 => 1,
            EdgeIndex::XAxisY0Z1 => 2,
            EdgeIndex::XAxisY1Z1 => 3,
            EdgeIndex::YAxisX0Z0 => 4,
            EdgeIndex::YAxisX1Z0 => 5,
            EdgeIndex::YAxisX0Z1 => 6,
            EdgeIndex::YAxisX1Z1 => 7,
            EdgeIndex::ZAxisX0Y0 => 8,
            EdgeIndex::ZAxisX1Y0 => 9,
            EdgeIndex::ZAxisX0Y1 => 10,
            EdgeIndex::ZAxisX1Y1 => 11,
        }
    }
}
...
impl VertexIndex {
    pub fn to_index(&self) -> usize {
        match self {
            VertexIndex::X0Y0Z0 => 0,
            VertexIndex::X1Y0Z0 => 1,
            VertexIndex::X0Y1Z0 => 2,
            VertexIndex::X1Y1Z0 => 3,
            VertexIndex::X0Y0Z1 => 4,
            VertexIndex::X1Y0Z1 => 5,
            VertexIndex::X0Y1Z1 => 6,
            VertexIndex::X1Y1Z1 => 7,
        }
    }
...
pub const SUBNODE_IN_EDGE: [[SubNodeIndex; 2]; EdgeIndex::COUNT] = EDGE_VERTEX_PAIRS;
