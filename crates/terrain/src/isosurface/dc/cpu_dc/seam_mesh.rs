...
// use crate::{
//     chunk_mgr::{
//         chunk::{bundle::TerrainChunk, state::TerrainChunkAddress},
...
//     octree::{node::Node, Octree, OctreeProxy},
// };
...
//     node_address_mapper: Arc<RwLock<HashMap<OctreeDepthType, Vec<MortonCode>>>>,
//     min_lod: LodType,
//     min_voxel_size: f32,
...
//     let mut seam_leaf_nodes: HashMap<MortonCode, Node> = HashMap::default();
//     let mut get_seam_leaf_nodes =
//         |subnode_index, octree: Arc<RwLock<HashMap<MortonCode, Node>>>| {
...
//     pub this: Option<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub this_lod: LodType,
//     pub right: Vec<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub right_lod: LodType,
//     pub top: Vec<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub top_lod: LodType,
//     pub front: Vec<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub front_lod: LodType,
//     pub x_axis_edge: Vec<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub x_axis_edge_lod: LodType,
//     pub y_axis_edge: Vec<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub y_axis_edge_lod: LodType,
//     pub z_axis_edge: Vec<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//     pub z_axis_edge_lod: LodType,
//     pub vertex: Option<Arc<RwLock<HashMap<MortonCode, Node>>>>,
...
//     pub this: MortonCode,
//     pub right: Vec<MortonCode>,
//     pub top: Vec<MortonCode>,
//     pub front: Vec<MortonCode>,
//     pub x_axis_edge: Vec<MortonCode>,
//     pub y_axis_edge: Vec<MortonCode>,
//     pub z_axis_edge: Vec<MortonCode>,
//     pub vertex: MortonCode,
// }
...
//                 let get_octree = |address: &MortonCode| -> (
//                     Option<Arc<RwLock<HashMap<MortonCode, Node>>>>,
//                     LodType,
//                 ) {
...
//                     (None, LodType::MAX)
//                 };
//                 let get_octrees = |addresses: &Vec<MortonCode>| {
...
//     node_addresses: Arc<RwLock<HashMap<MortonCode, Node>>>,
//     chunk_address: TerrainChunkAddress,
//     lod: LodType,
// ) -> (Entity, MeshInfo) {
