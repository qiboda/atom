...
// #[derive(Component)]
// pub struct Octree {
//     pub address_node_map: Arc<RwLock<HashMap<MortonCode, Node>>>,
//    pub node_shape: ndshape::RuntimeShape<u32, 3>,
// }

// #[derive()]
// pub struct OctreeProxy<'a> {
//     pub node_addresses: RwLockReadGuard<'a, HashMap<MortonCode, Node>>,
//     pub is_seam: bool,
...
//         node_address: Arc<RwLock<HashMap<OctreeDepthType, Vec<MortonCode>>>>,
//     ) where
...
// impl Octree {
//     #[cfg(debug_assertions)]
//     pub fn check_nodes_relation(node_addresses: Arc<RwLock<HashMap<MortonCode, Node>>>) {
...
//         node_addresses: &'a RwLockReadGuard<HashMap<MortonCode, Node>>,
//         octree_aabb: Aabb3d,
