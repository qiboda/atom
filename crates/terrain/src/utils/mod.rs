...
use crate::isosurface::dc::octree::tables::SubNodeIndex;

pub struct OctreeUtil;

impl OctreeUtil {
    pub fn get_subnode_aabb(parent_aabb: Aabb3d, subnode_index: SubNodeIndex) -> Aabb3d {
...
mod tests {
    ...
    fn test_subnode_aabb() {
        ...
        let subnode_aabb = OctreeUtil::get_subnode_aabb(parent_aabb, SubNodeIndex::X0Y0Z0);
        assert_eq!(subnode_aabb.min, Vec3A::new(-10.0, -10.0, -10.0));
        assert_eq!(subnode_aabb.max, Vec3A::new(0.0, 0.0, 0.0));

        let subnode_aabb = OctreeUtil::get_subnode_aabb(parent_aabb, SubNodeIndex::X0Y1Z0);
