...
use crate::terrain::{
    isosurface::octree::{cell::CellType, face::FaceType},
...
pub fn make_octree_structure(
    ...
    address.set(CellAddress { raw_address: 1 }, SubCellIndex::LeftBottomBack);
    ...
    subdivide_cell(octree, address, c000, voxel_num, policy);
