...
use crate::bundle::ActiveCamera;

pub struct ActiveCameraControllerPlugin;

impl Plugin for ActiveCameraControllerPlugin {
...
fn run_camera_controller(
    ...
    mut query: Query<(&mut Transform, &mut CameraController), With<ActiveCamera>>,
) {
