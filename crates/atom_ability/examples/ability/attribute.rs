use atom_ability::attribute::{
    Attribute, attribute_set::AttributeSet, implement::attr_base::ValueAttribute,
};
...
impl AttributeSet for BaseAttributeSet {
    ...
    ) -> &dyn atom_ability::attribute::Attribute {
        match attribute_set_enum {
    ...
    fn get_attr_mut(
        &mut self,
        attribute_set_enum: Self::AttributeSetEnum,
    ) -> &mut dyn atom_ability::attribute::Attribute {
        match attribute_set_enum {
...
mod test {
    ...
    use atom_ability::attribute::attribute_set::AttributeSet;
