...
#[derive(bevy::reflect::Reflect, Debug, macros::TryIntoBase)]
pub struct Circle {
    /// 半径
    pub radius: f32,
}
...
impl TbMultiIndexList {
    pub fn new(mut buf: luban_lib::ByteBuf) -> Result<TbMultiIndexList, LubanError> {
        ...
        let mut data_map_id1: bevy::utils::HashMap<i32, std::sync::Arc<crate::MultiIndexList>> =
            Default::default();
        let mut data_map_id2: bevy::utils::HashMap<i32, std::sync::Arc<crate::MultiIndexList>> =
            Default::default();
        let mut data_map_id3: bevy::utils::HashMap<String, std::sync::Arc<crate::MultiIndexList>> =
            Default::default();
        for x in &data_list {
...
pub struct TbMultiUnionIndexList {
    ...
    pub data_map_union:
        bevy::utils::HashMap<(i32, i32, String), std::sync::Arc<crate::MultiUnionIndexList>>,
}
...
impl TbMultiUnionIndexList {
    pub fn new(mut buf: luban_lib::ByteBuf) -> Result<TbMultiUnionIndexList, LubanError> {
        ...
        let mut data_map_union: bevy::utils::HashMap<
            (i32, i32, String),
            std::sync::Arc<crate::MultiUnionIndexList>,
        > = Default::default();
        for x in &data_list {
    ...
    pub fn get(
        &self,
        key: &(i32, i32, String),
    ) -> Option<std::sync::Arc<crate::MultiUnionIndexList>> {
